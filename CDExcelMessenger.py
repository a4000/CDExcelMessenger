...
def updateCDResultsFile(cdResultsFilePath, excelFilePath, excelSheetName, updateColNameList = None, optionalTagDict = None, tagVisability = None, verbose = True):
...
def updateExcelFile(cdResultsFilePath, excelFilePath, excelSheetName, updateColNameList = None, optionalTagList = None, verbose = True):
