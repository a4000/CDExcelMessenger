...
def getTagBytes(tagString):
    ...
    # Attribute error is thrown when there is no tags
...
'''
    ...
    'hideMessages' = Boolean value that controls whether or not the print statements get run. Set to True to hide messages (default is False)
'''
    ...
    try:
        ...
        if not excelData.empty:
                    ...
                    if colDisplayName in excelData.columns:
                        ...
                        for row in range(excelRowCount):
                            ...
                            if colSQLiteName == "Tags":
                                ...
                                if value == -1:
                                    value = b"\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
                            
                            # The Checked column also needs to be handled differently
                            elif colSQLiteName == "Checked": 
            ...
            # If the results file can't be found
                ...
                if hideMessages == False: 
                    missingCDResultsMessage(cdResultsFileName)
